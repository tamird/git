...
test_expect_success 'rebase from ambiguous branch name' '
	...
	test_trace2_data cache_tree validate/calls-total 2 <rebase.trace &&
	test_trace2_data cache_tree validate/valid-total 2 <rebase.trace &&
	test "$(grep -c "\"category\":\"cache_tree\",\"key\":\"validate/calls-total\"" rebase.trace)" = 2 &&
	test_grep ! "\"category\":\"sequencer\",\"name\":\"empty-check/cache-tree-validate/" rebase.trace &&
	test_grep ! "\"event\":\"timer\".*\"category\":\"sequencer\",\"name\":\"empty-check/cache-tree-validate\"," rebase.trace &&
