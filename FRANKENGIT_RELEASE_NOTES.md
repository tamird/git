...
> Historical snapshot: The benchmark results and hardware details below
> were recorded in June 2026 and have not been remeasured on the current
> branch.
...
These examples modify global configuration or repository indexes. Review
repository ownership, Git-version compatibility, runtime, and disk usage
