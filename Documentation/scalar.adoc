...
index.skipHash=true::
	Disable computing the hash of ordinary index files as they are being
	written. Shared index files are still hashed because their trailing
	hash identifies the file. This assists with performance, especially
